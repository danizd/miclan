...
-- Generation Time: Feb 05, 2016 at 01:05 PM
...
(635, 'danizd', '2016-02-02 10:35:03', '127.0.0.1', 0),
(636, 'danizd', '2016-02-02 11:48:43', '127.0.0.1', 0),
(637, 'danizd', '2016-02-02 13:33:25', '127.0.0.1', 0),
(638, 'danizd', '2016-02-02 16:18:26', '127.0.0.1', 0),
(639, 'danizd', '2016-02-03 08:36:15', '127.0.0.1', 0),
(640, 'danizd', '2016-02-03 16:05:42', '127.0.0.1', 0),
(641, 'danizd', '2016-02-04 08:46:30', '127.0.0.1', 0),
(642, 'danizd', '2016-02-05 11:15:30', '127.0.0.1', 0),
(643, 'elena', '2016-02-05 11:23:03', '127.0.0.1', 0);
...
--
-- Table structure for table `pulsar`
--

CREATE TABLE `pulsar` (
  `idPulsar` int(4) NOT NULL AUTO_INCREMENT,
  `userID` int(4) NOT NULL,
  `valor` int(11) NOT NULL,
  `creada` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idPulsar`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12 ;

--
-- Dumping data for table `pulsar`
--

INSERT INTO `pulsar` (`idPulsar`, `userID`, `valor`, `creada`) VALUES
(1, 1, 35, '2016-02-02 15:54:30'),
(2, 2, 0, '2016-02-02 15:54:30');

-- --------------------------------------------------------

--
-- Table structure for table `quever`
--
...
(3, 'horasSemana', '3', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
