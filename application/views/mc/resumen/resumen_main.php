...
<head>
    ...
    ============================== -->
    <link rel="stylesheet" href="/assets/portada/css/bootstrap.css">
    <link rel="stylesheet" href="/assets/portada/css/animate.min.css">

    <!-- =========================
       Fonts, typography and icons
    ============================== -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="/assets/portada/css/font-awesome.css">
    <link rel="stylesheet" href="/assets/portada/css/typography.css">

    <!-- =========================
       Carousel, lightbox and circle generator
    ============================== -->
    <link rel="stylesheet" href="/assets/portada/css/owl.carousel.css">
    <link rel="stylesheet" href="/assets/portada/css/owl.theme.css">
    <link rel="stylesheet" href="/assets/portada/css/nivo-lightbox.css">
    <link rel="stylesheet" href="/assets/portada/css/nivo-lightbox-default.css">
    <link rel="stylesheet" href="/assets/portada/css/jquery.circliful.css">

    <!-- ***** Custom Stylesheet ***** -->
    <link rel="stylesheet" href="/assets/portada/css/main.css">

    <!-- ***** Responsive fixes ***** -->
    <link rel="stylesheet" href="/assets/portada/css/responsive.css">

    <!-- Header scripts -->
    <script src="/assets/portada/js/vendor/modernizr-2.8.3.min.js"></script>
    <script src="/assets/portada/js/queryloader2.min.js"></script>
...
<body>
    ...
    <!-- =========================
     JavaScripts
    ============================== -->
    <script src="/assets/portada/js/vendor/jquery-1.11.1.js"></script>
    <script src="js/vendor/jquery-migrate-1.2.1.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBOsiOjjoOiFBmXLU0adNjsnCKLpcDfRyI"></script>
    <script src="/assets/portada/js/twitterFetcher_min.js"></script>
    <script src="/assets/portada/js/vendor/bootstrap.js"></script>
    <script src="/assets/portada/js/wow.min.js"></script>
    <script src="/assets/portada/js/imagesloaded.pkgd.min.js"></script>
    <script src="/assets/portada/js/jquery.easing.min.js"></script>
    <script src="/assets/portada/js/appear.js"></script>
    <script src="/assets/portada/js/jquery.circliful.min.js"></script>
    <script src="/assets/portada/js/owl.carousel.min.js"></script>
    <script src="/assets/portada/js/nivo-lightbox.min.js"></script>
    <script src="/assets/portada/js/isotope.pkgd.min.js"></script>
    <script src="/assets/portada/js/notie.js"></script>
    <script src="/assets/portada/js/main.js"></script>
</body>
</html>
